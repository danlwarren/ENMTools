#####
# Raster breadth file, calculates standardized versions of B1 and B2 from Levins 1968.
# Expects to be fed a file name, returns a vector of B1 and B2
#####
raster.breadth <- function(x){
  proceed <- TRUE
  if(!file.exists(x)){
