#' rangebreak.libear Conduct a linear or blob rangebreak test as described in Glor and Warren 2011.
#'
#'
...
#'
#' @examples
#' rangebreak.test(ahli, allogus, env, type = "glm", f = layer.1 + layer.2 + layer.3, nreps = 10, ...)
#'
