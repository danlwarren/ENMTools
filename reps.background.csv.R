...
# Given a csv file, creates replicates for conducting the background test of Warren et al. 2008.
...
reps.background.csv <- function(infile = x, outfile = FALSE, points, reps = 10){
