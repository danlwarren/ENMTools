#####
# Raster overlap function, part of ENMTools.R
# Calculates I and Schoener's D from two .asc files.
# Expects to be fed filenames, returns a vector with D and I.
#####
raster.overlap <- function(x, y){
  proceed <- TRUE
  if(!file.exists(x)){
