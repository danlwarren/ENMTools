...
* Added a new general-purpose function for making background layers from point data.  It can do both circular buffers and buffered convex hulls, and can return points, a polygon, or a raster.  We'll probably want to convert the existing background buffer functions to just call this one, and eventually deprecate the single-application functions.
